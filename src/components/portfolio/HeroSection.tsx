  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          Bridging AI innovation with elegant frontend solutions to create intelligent digital experiences
        </motion.p>
        ...
        >
          {[
            { href: "https://github.com/aldrichcortero", icon: "simple-icons:github", label: "GitHub", color: "hover:text-gray-900 dark:hover:text-white" },
            { href: "https://linkedin.com/in/aldrich-cortero", icon: "skill-icons:linkedin", label: "LinkedIn", color: "hover:text-blue-600" },
            { href: "mailto:abdidvp@gmail.com", icon: "material-icon-theme:email", label: "Email", color: "hover:text-green-600" }
          ].map((link) => (
